...
export const chatbotSystemPrompts: Record<SupportedLocale, string> = {
...
export const reminderTemplates: Record<SupportedLocale, string> = {
...
export const voiceGreetings: Record<SupportedLocale, string> = {
